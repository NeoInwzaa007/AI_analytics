...
response_opts = requests.options('http://127.0.0.1:8888/api/auth/register', headers=headers)
...
response_post = requests.post('http://127.0.0.1:8888/api/auth/register', json=data)
